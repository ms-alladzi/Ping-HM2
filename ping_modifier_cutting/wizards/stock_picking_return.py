...
class ReturnPickingLine(models.TransientModel):
    ...
    lot_id          = fields.Many2one('stock.production.lot', string="Lot Product")
    lot_domain      = fields.Many2many('stock.production.lot',string="Lot Domain")
    #lot_domain      = fields.Char(string="Lot Domain")
    ...
    def default_get(self, fields):
        ...
        if picking:
            ...
            for move in picking.move_lines:
                ...
                print "move----->>", move.lot_ids.ids
                
                
                product_return_moves.append((0, 0, {'product_id': move.product_id.id, 'quantity': quantity, 'move_id': move.id, 'lot_domain': [(6,0, move.lot_ids.ids)]}))
